...
export class BackgroundModalComponent implements OnInit {
  ...
  constructor(private alert: AlertService, public fabricService: FabricService) { }
  ...
  backgroundList: Array<backgroundPropos>
  loading = false;
  ...
  handleChange(info: { file: NzUploadFile }): void {
    switch (info.file.status) {
      case 'uploading':
        ...
        break;
      case 'done':
        this.alert.MessageAlert('success', "上传成功", 1000)
        // TODO:重新拉取backgroundList
        break;
      case 'error':
        this.alert.MessageAlert('error', "上传失败", 1000)
        this.loading = false;
        break;
    }
  }
  ...
  imageSave() {
    ...
    this.fabricService.setBackground(this.backgroundUrl, 100 * this.rem, 75 * this.rem)
